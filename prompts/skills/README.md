...
| `complaint-arbitration-extract` | 起诉状 / 仲裁申请书副本 | 9 | 原告/申请人、被告/被申请人、涉及主体、标准案由、业务类型、受理法院/仲裁委、标的额、诉讼请求金额、赔偿金 |
| `evidence-notice-extract` | 举证通知书 | 7 | 案号、被告/被申请人、涉及主体、受理法院/仲裁委、标准案由、业务类型、举证期限 |
| `judgment-ruling-mediation-extract` | 判决书 / 裁定书 / 调解书 | 11 | 案号、原告/申请人、被告/被申请人、涉及主体、受理法院/仲裁委、标准案由、业务类型、标的额、赔偿金、诉讼请求金额、裁判结果 |
| `defense-notice-extract` | 应诉通知书 / 参加诉讼通知书 | 8 | 案号、原告/申请人、被告/被申请人、涉及主体、标准案由、业务类型、受理法院/仲裁委、立案日期 |
| `summons-hearing-extract` | 传票 / 开庭通知书 / 改期开庭通知书 | 8 | 案号、被告/被申请人、涉及主体、受理法院/仲裁委、应到时间、标准案由、业务类型、应到地点 |
| `appeal-extract` | 上诉状 | 10 | 案号、原告/申请人、被告/被申请人、涉及主体、标准案由、业务类型、受理法院/仲裁委、标的额、诉讼请求金额、上诉请求 |
...
- 金额字段采用「触发词 + 金额正则」提取，触发词为**示例词表（非穷举）**：语义相同或相近、且明确指向该字段金额的表述同样视为命中；命中后仍须在附近匹配到金额数字，否则输出 `null`
